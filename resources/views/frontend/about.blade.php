...
<div class="about-section">
  ...
  <div class="row">
    <div class="column">
      <div class="card">
        <img src="../storage/image/Jane.jpg" alt="Jane" style="width:100%">
        <div class="container">
          <h2>Jane Doe</h2>
    ...
    <div class="column">
      <div class="card">
        <img src="../storage/image/Ross.jpg" alt="Mike" style="width:100%">
        <div class="container">
          <h2>Mike Ross</h2>
    ...
    <div class="column">
      <div class="card">
        <img src="../storage/image/John.jpg" alt="John" style="width:100%">
        <div class="container">
          <h2>John Doe</h2>
